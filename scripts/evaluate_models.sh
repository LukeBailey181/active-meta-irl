...
# bash scripts/evaluate_models.sh [experiment config] [save directory] [save csv]
...
# Luke Examples 
# ./scripts/evaluate_models.sh ./configs/bc/bc_al_cfg.yaml ./logs/bc-al-big-map/gam ./logs/evals/bc-al-big-map/gam/bc_al_eval.csv
